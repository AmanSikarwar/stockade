...
from app.schemas.customers import CustomerCreateRequest, CustomerListResponse, CustomerResponse
...
def list_customers(
    ...
    service = CustomerService(session, current_user.organization_id)
    customers, total = service.list_customers(limit=limit, offset=offset, search=q)
